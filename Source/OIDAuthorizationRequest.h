...
/*! @brief Deprecated, use @c OIDAuthState.initWithConfiguration:clientId:clientSecret:scope:redirectURL:responseType:state:codeVerifier:codeChallenge:codeChallengeMethod:additionalParameters:.
    @param configuration The service's configuration.
    @param clientID The client identifier.
...
- (instancetype)
    initWithConfiguration:(OIDServiceConfiguration *)configuration
     ...
     additionalParameters:(nullable NSDictionary<NSString *, NSString *> *)additionalParameters
     __deprecated_msg("Use OIDAuthState.initWithConfiguration:clientId:clientSecret:scope:redirectURL:responseType:state:codeVerifier:codeChallenge:codeChallengeMethod:additionalParameters:");
