...
- (nullable instancetype)initWithConfiguration:(OIDServiceConfiguration *)configuration
  ...
  NSString *codeChallenge = [[self class] S256CodeChallengeForVerifier:codeVerifier];
  ...
  return [self initWithConfiguration:configuration
                 ...
                 codeChallengeMethod:kPKCEChallengeMethodS256
...
+ (nullable NSString *)S256CodeChallengeForVerifier:(NSString *)codeVerifier {
  if (!codeVerifier) {
    return nil;
  }
