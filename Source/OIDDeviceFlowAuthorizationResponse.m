/*! @file OIDDeviceFlowAuthorizationResponse.m
...
NSString *const OIDDeviceFlowDeviceTokenGrantType = @"urn:ietf:params:oauth:grant-type:device_code";
...
@implementation OIDDeviceFlowAuthorizationResponse
...
- (instancetype)initWithRequest:(OIDDeviceFlowAuthorizationRequest *)request
...
- (OIDTokenRequest *)tokenPollRequestWithAdditionalParameters:
  ...
  OIDTokenRequest *pollRequest =
      [[OIDTokenRequest alloc] initWithConfiguration:self.request.configuration
                                           grantType:OIDDeviceFlowDeviceTokenGrantType
