...
#import "OIDDeviceFlowAuthorizationService.h"
...
#import "OIDDeviceFlowAuthorizationResponse.h"
 ...
 */
NSString *const kDeviceFlowErrorCodeAuthorizationPending = @"authorization_pending";

/*! @brief The slow down error code.
    @see https://developers.google.com/identity/protocols/OAuth2ForDevices
 */
NSString *const kDeviceFlowErrorCodeSlowDown = @"slow_down";

@implementation OIDDeviceFlowAuthorizationService
...
+ (OIDDeviceFlowAuthorizationCancelBlock)authorizeTVRequest:(OIDDeviceFlowAuthorizationRequest *)request
  ...
  OIDDeviceFlowAuthorizationCancelBlock cancelBlock = ^{
    if (pollRunning) {
  ...
  [[session dataTaskWithRequest:URLRequest
    ...
    OIDDeviceFlowAuthorizationResponse *TVAuthorizationResponse =
        [[OIDDeviceFlowAuthorizationResponse alloc] initWithRequest:request parameters:json];
          ...
          dispatch_async(dispatch_get_main_queue(), ^() {
            if (tokenResponse) {
              ...
              if (tokenError.domain == OIDOAuthTokenErrorDomain) {
                ...
                if ([errorCode isEqual:kDeviceFlowErrorCodeAuthorizationPending]) {
                  // authorization_pending is an expected response.
                  return;
                } else if ([errorCode isEqual:kDeviceFlowErrorCodeSlowDown]) {
