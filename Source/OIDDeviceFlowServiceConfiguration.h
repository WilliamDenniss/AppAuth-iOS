/*! @file OIDDeviceFlowServiceConfiguration.h
...
/*! @brief Configuration for authorizing the user with the @c OIDDeviceFlowAuthorizationService.
 */
@interface OIDDeviceFlowServiceConfiguration : OIDServiceConfiguration
